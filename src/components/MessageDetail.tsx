    ...
    <div className="px-4 py-4 space-y-4">
      ...
      <div className="group/actions flex items-center gap-2 pt-2 border-t border-gray-100 dark:border-gray-700">
        ...
        <button
          ...
          title="Copy text"
          className="text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 opacity-0 group-hover/actions:opacity-100 focus:opacity-100 transition-opacity"
        >
